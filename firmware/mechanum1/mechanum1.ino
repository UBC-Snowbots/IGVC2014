  ...
  { 
    ...
    while(hal.console->available() >=10)
    {
      ...
      if(Byte[0]=='B')// make sure all data begains with a zero
      {
        ...
        // hal.console->println(Byte[1]);
        // hal.console->println(Byte[2]);
        // hal.console->println(Byte[3]);
        /*
      twist_x=((int)Byte[1]*8-500);
        ...
        //test=Byte[1];
        /*
        hal.console->printf("%u",twist_x);
         hal.console->printf("%u",twist_y);
         hal.console->printf("%u",twist_z);
         */
